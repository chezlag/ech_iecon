...
gen at_milit2 = e45_4 == 1 & ((e45_1_1 != 1 & e45_1_1 !=4) & (e45_2_1 != 1 & e45_2_1!=6) & (e45_3_1 != 1& e45_3_1 !=6))
recode at_milit2 .=0
...
gen ramamilit_op = 1 if  f72_2  == 8411 | f72_2 == 8422 | f72_2  == 8423 | f72_2  == 8430 | f72_2  == 8521 | f72_2  == 8530 | f72_2  == 8610   
...
gen ramamilit_os = 1 if f91_2  == 8411 | f91_2 == 8422 | f91_2  == 8423 | f91_2  == 8430 | f91_2  == 8521 | f91_2  == 8530 | f91_2  == 8610
...
* Enero
gen afameq=0
*replace afameq= 865.53*((g151_1+g151_2+g151_3)^0.6)+ 370.95*(g151_3_1^0.6) + 1236.48*g151_4 if bc_mes==1 & g256==2 & g152==1
*replace afameq= 865.53*((g151_1+g151_2+g151_3)^0.6)+ 370.95*(g151_3_1^0.6) + 1236.48*g151_4 if bc_mes==1 & (g150==1 & (pobpcoac == 3 | pobpcoac == 4 | pobpcoac == 6 | pobpcoac == 7 | pobpcoac == 8 | pobpcoac == 11 | (pobpcoac == 2 & f82 != 1 & f96 != 1)))
*replace afameq= 865.53*((g151_1+g151_2+g151_3)^0.6)+ 370.95*(g151_3_1^0.6) + 1236.48*g151_4 if bc_mes==1 & g255==1 & g256==2
replace afameq=  865.53*((g151_1+g151_2+g151_3)^0.6)+ 370.95*(g151_3^0.6) + 1236.48*g151_4 if bc_mes==1 & g150==2 & g152==1

*Resto del año.
*replace afameq= 939.96*((g151_1+g151_2+g151_3)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes>1 & g256==2 & g152==1
*replace afameq= 939.96*((g151_1+g151_2+g151_3)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes>1 & (g150==1 & (pobpcoac == 3 | pobpcoac == 4 | pobpcoac == 6 | pobpcoac == 7 | pobpcoac == 8 | pobpcoac == 11 | (pobpcoac == 2 & f82 != 1 & f96 != 1)))
*replace afameq= 939.96*((g151_1+g151_2+g151_3)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes>1 & g255==1 & g256==2
replace afameq = 939.96*((g151_1+g151_2+g151_3)^0.6)+ 402.85*(g151_3^0.6) + 1342.81*g151_4 if bc_mes>1 & g150==2 & g152==1
...
gen suma1=0
replace suma1= (g126_1 + g126_2 + g126_3)*1.22 if ((f73 == 1 | f73 == 2 | f73 == 8) & f82 == 1)

gen suma2= 0
replace suma2= (g134_1 + g134_2 + g134_3)*1.22 if ((f92 == 1 | f92 == 2) & f96 == 1)

gen suma3=0
replace suma3= (g142 +g143/12) if ((f73> 2 & f73 <7) & f82 == 1) | ((f92 >2 & f92 <7) | f96 == 1)

gen suma4 =0
replace suma4= g148_1_1 + g148_1_2 + g148_1_3 + g148_1_4 + g148_1_5 + g148_1_6 + g148_1_7 + g148_1_8 + g148_1_9 + g148_1_10 + g148_1_11 + g148_1_12 + /*
...
egen suma_nucleo = sum(suma), by(bc_correlat nucleo)
*/
gen nucleo = bc_nper
replace nucleo = 1 if e30==2
replace nucleo = 99 if e30==14

gen suma =  g126_1 +g126_2 +g126_3 +g134_1+g134_2+ g134_3
gen suma2 = suma*1.22

egen suma3 = sum(suma2), by(bc_correlat nucleo)
gen monto_asig=0
replace monto_asig=386.72 if suma3<=14502
replace monto_asig=193.36 if suma3>14502
...
g DESAYMER = 0
	replace DESAYMER = (e57_4_1 + e196_1 + e196_3 + e200_1 +e200_3 + e211_1 + e211_3)*4.3*mto_desa 

g ALMYCEN = 0
	replace ALMYCEN = (e57_4_2 + e196_2+ e200_2 + e211_2)*4.3*mto_almu
...
g YTRANSF_1 = 0
	...
	*/ g148_1_7 + g148_1_8 + g148_1_9 + g148_1_12 + g148_1_10 + g148_1_11+ g148_2_1+ g148_2_2 /*
	*/+ g148_2_3 + g148_2_4+ g148_2_5+ g148_2_6+ g148_2_7+ g148_2_8+ g148_2_9 + g148_2_12 + /*
...
replace yhog_iecon= h155_1+h156_1+ h157_1+ h252_1 + (h160_1/12)+(h160_2/12)+(h163_1/12)+(h163_2/12)+/*
*/(h164/12)+(h165/12)+(h166/12) +(h168_1/12)+(h168_2/12)+(h170_1/12)+(h170_2/12)+(h171_1/12)+(h172_1/12)/*
*/+ cuotmilit_hogar + YALIMENT_MEN + totfonasa_hogar2 +EMER_OTRO_TOT+  CUOT_OTROHOG2
...
g afam_pe=0
	...
	replace afam_pe=1 if (g150==1 | g150==2) & (pobpcoac==1 | pobpcoac==3 | pobpcoac==4 | pobpcoac==6 | /*
	*/ pobpcoac==7 | pobpcoac==8 | pobpcoac==11 | (pobpcoac==2 & f82!=1 & f96!=1))
	
*Otras AFAM

g afam_cont=0
	replace afam_cont=1 if (g150==1 | g150==2) & afam_pe==0
g afam_cont_pub=0
...
*** BENEFICIARIOS ***
g cant_af=(g151_1+g151_2+g151_3+g151_4)
...
g monto_afam_pe=0
	replace monto_afam_pe=(865.53*((g151_1+g151_2+g151_3)^0.6)+370.95*(g151_3^0.6))+g151_4*(865.53+370.95) if bc_mes==1 &afam_pe==1
	replace monto_afam_pe=(939.96*((g151_1+g151_2+g151_3)^0.6)+402.85*(g151_3^0.6))+g151_4*(939.96+402.85) if afam_pe==1&bc_mes>1

*-------------------------------------------------------------------------------
* AFAM_CON - Código Iecon

cap drop nucleo suma* monto_asig 
gen nucleo = bc_nper
replace nucleo = min(bc_nper,e34) if e34!=0
...
by bc_correlat: replace monto_tus_iecon = 523 if (n_menores==1 | n_menores==0) & bc_mes<5   & h157==1
by bc_correlat: replace monto_tus_iecon = 616 if (n_menores==1 | n_menores==0) & 4<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 626 if (n_menores==1 | n_menores==0) & bc_mes>7   & h157==1

by bc_correlat: replace monto_tus_iecon = 793 if (n_menores==2) & bc_mes<5   & h157==1
by bc_correlat: replace monto_tus_iecon = 934 if (n_menores==2) & 4<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 949 if (n_menores==2)  & bc_mes>7  & h157==1

by bc_correlat: replace monto_tus_iecon = 1009 if (n_menores==3) & bc_mes<5   & h157==1
by bc_correlat: replace monto_tus_iecon = 1188 if (n_menores==3) & 4<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1207 if (n_menores==3)  & bc_mes>7  & h157==1

by bc_correlat: replace monto_tus_iecon = 1406 if (n_menores>3) & bc_mes<5   & h157==1
by bc_correlat: replace monto_tus_iecon = 1656 if (n_menores>3) & 4<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1682 if (n_menores>3)  & bc_mes>7  & h157==1
