...
* ipc
g bc_ipc=-15
replace	bc_ipc=	8.76554467	if	bc_mes==	1
replace	bc_ipc=	8.42825786	if	bc_mes==	2
replace	bc_ipc=	8.14411657	if	bc_mes==	3
replace	bc_ipc=	7.86213164	if	bc_mes==	4
replace	bc_ipc=	7.55049427	if	bc_mes==	5
replace	bc_ipc=	7.21106109	if	bc_mes==	6
replace	bc_ipc=	6.93336989	if	bc_mes==	7
replace	bc_ipc=	6.73040903	if	bc_mes==	8
replace	bc_ipc=	6.47125907	if	bc_mes==	9
replace	bc_ipc=	6.24089552	if	bc_mes==	10
replace	bc_ipc=	6.10757985	if	bc_mes==	11
replace	bc_ipc=	5.94496233	if	bc_mes==	12
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom93",replace
restore
drop if bc_pe4==7
