...
* ipc
g bc_ipc=-15
replace bc_ipc=1.88873972142977 if bc_mes==1&bc_anio==1999
replace bc_ipc=1.87645881960654 if bc_mes==2&bc_anio==1999
replace bc_ipc=1.87317966214529 if bc_mes==3&bc_anio==1999
replace bc_ipc=1.8691355974425 if bc_mes==4&bc_anio==1999
replace bc_ipc=1.85313246068988 if bc_mes==5&bc_anio==1999
replace bc_ipc=1.85023836922571 if bc_mes==6&bc_anio==1999
replace bc_ipc=1.84902250698209 if bc_mes==7&bc_anio==1999
replace bc_ipc=1.84191146387366 if bc_mes==8&bc_anio==1999
replace bc_ipc=1.83515408446111 if bc_mes==9&bc_anio==1999
replace bc_ipc=1.83470535495965 if bc_mes==10&bc_anio==1999
replace bc_ipc=1.82874319603542 if bc_mes==11&bc_anio==1999
replace bc_ipc=1.82874319603542 if bc_mes==12&bc_anio==1999
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom99",replace
restore
drop if bc_pe4==7
