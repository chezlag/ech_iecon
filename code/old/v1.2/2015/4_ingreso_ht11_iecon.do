...
*otra forma
/*
* h157_1 está la variable en ine, no en la base
g yhog_iecon2 = 0
replace yhog_iecon2 = h155_1+h156_1+ h252_1 + (h160_1/12)+(h160_2/12)+(h163_1/12)+(h163_2/12)+(h164/12)+(h165/12)+(h166/12) + /*
*/(h269_1/12) + (h167_1_1/12)+(h167_1_2/12)+ (h167_2_1/12) + (h167_2_2/12)+ (h167_3_1/12) + (h167_3_2/12) + /*
*/(h167_4_1/12) + (h167_4_2/12)+ (h170_1/12)+(h170_2/12)+ (h271_1/12) + (h171_1/12)+(h172_1/12) /*
*/+ cuotmilit_hogar + YALIMENT_MEN + totfonasa_hogar2 +EMER_OTRO_TOT+  CUOT_OTROHOG2
replace yhog_iecon2=0 if bc_nper!=1

egen YHOG_MAX2=max(yhog_iecon2), by(bc_correlat)
	
replace yhog_iecon2=YHOG_MAX2
drop YHOG_MAX2
*/

/* Se realizó la replicación de ine en base a sintaxis en spss
y para los bc_correlat 2015012971 y 2015019411 no existen diferencias pese
a que en la base original del ine sí.
*/
...
compare ht11 ht11_iecon if abs( ht11- ht11_iecon)>3
...
g monto_afam_pe=0
	replace monto_afam_pe=(1096.35*((g151_5+g151_1+g151_2+g151_3)^0.6)+469.87*(g151_3_1^0.6))+g151_4*(1096.35+469.87) if bc_mes==1 &afam_pe==1
	replace monto_afam_pe=(1186.91*((g151_5+g151_1+g151_2+g151_3)^0.6)+508.68*(g151_3_1^0.6))+g151_4*(1186.91+508.68) if afam_pe==1&bc_mes>1
...
recode menores .=0
by bc_correlat: egen n_menores=sum(menores)

gen monto_tus_iecon = 0
by bc_correlat: replace monto_tus_iecon = 955 if (n_menores==1 | n_menores==0) & bc_mes>1   & tus>0
by bc_correlat: replace monto_tus_iecon = 887 if (n_menores==1 | n_menores==0) & bc_mes==1  & tus>0
by bc_correlat: replace monto_tus_iecon = 1448 if n_menores==2 & bc_mes>1  & tus>0
by bc_correlat: replace monto_tus_iecon = 1344 if n_menores==2 & bc_mes==1 & tus>0
by bc_correlat: replace monto_tus_iecon = 1843 if n_menores==3 & bc_mes>1  & tus>0
by bc_correlat: replace monto_tus_iecon = 1711 if n_menores==3 & bc_mes==1 & tus>0
by bc_correlat: replace monto_tus_iecon = 2567 if n_menores>3 & bc_mes>1   & tus>0
by bc_correlat: replace monto_tus_iecon = 2383 if n_menores>3 & bc_mes==1  & tus>0
