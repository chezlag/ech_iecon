...
drop YALIMENT
g YALIMENT=DESAYMER + ALMYCEN + CANASTA + leche	// Se incluye imputación tus del iecon
...
g yaliment_men=DESAYMER + ALMYCEN + CANASTA +leche if bc_pe3<=13  /*No se incluyen tickets porque ya no se preguntan*/
