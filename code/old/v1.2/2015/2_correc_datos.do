...
u "$rutaoriginales\Fusionado_2015_terceros", clear
...
*-------------------------------------------------------------------------------
* Renombro variables del ine (para variables de ingreso se deshace el rename
* en paso 8.)
...
*-------------------------------------------------------------------------------
*- La variable orig de ine para ht11 solo tenía valores para nper==1
bys numero: egen max_ht11=max(ht11) if e30!=14
replace ht11=max_ht11
recode ht11 (.=0)
