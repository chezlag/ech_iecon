...
* Enero
gen afameq=0
replace afameq= 939.96*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes==1 & g256==2 & g152==1
replace afameq= 939.96*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes==1 & (g150==1 & (pobpcoac == 3 | pobpcoac == 4 | pobpcoac == 6 | pobpcoac == 7 | pobpcoac == 8 | pobpcoac == 11 | (pobpcoac == 2 & f82 != 1 & f96 != 1)))
replace afameq= 939.96*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 402.85*(g151_3_1^0.6) + 1342.81*g151_4 if bc_mes==1 & g255==1 & g256==2
...
gen monto_asig=0
replace monto_asig=415.68 if suma_nucleo<=15588
replace monto_asig=207.84 if suma_nucleo>15588
...
g monto_afam_pe=0
	replace monto_afam_pe=(939.96*((g151_5+g151_1+g151_2+g151_3)^0.6)+402.85*(g151_3_1^0.6))+g151_4*(939.96+402.85) if bc_mes==1 &afam_pe==1
	replace monto_afam_pe=(1010.27*((g151_5+g151_1+g151_2+g151_3)^0.6)+432.98*(g151_3_1^0.6))+g151_4*(1010.27+432.98) if afam_pe==1&bc_mes>1
...
by bc_correlat: replace monto_tus_iecon = 626 if (n_menores==1 | n_menores==0) & bc_mes<4   & h157==1
by bc_correlat: replace monto_tus_iecon = 684 if (n_menores==1 | n_menores==0) & 3<bc_mes<10 & h157==1
by bc_correlat: replace monto_tus_iecon = 700 if (n_menores==1 | n_menores==0) & bc_mes>9   & h157==1

by bc_correlat: replace monto_tus_iecon = 949 if (n_menores==2) & bc_mes<4   & h157==1
by bc_correlat: replace monto_tus_iecon = 1037 if (n_menores==2) & 3<bc_mes<10 & h157==1
by bc_correlat: replace monto_tus_iecon = 1062 if (n_menores==2)  & bc_mes>9  & h157==1

by bc_correlat: replace monto_tus_iecon = 1207 if (n_menores==3) & bc_mes<4   & h157==1
by bc_correlat: replace monto_tus_iecon = 1319 if (n_menores==3) & 3<bc_mes<10 & h157==1
by bc_correlat: replace monto_tus_iecon = 1350 if (n_menores==3)  & bc_mes>9  & h157==1

by bc_correlat: replace monto_tus_iecon = 1682 if (n_menores>3) & bc_mes<4   & h157==1
by bc_correlat: replace monto_tus_iecon = 1839 if (n_menores>3) & 3<bc_mes<10 & h157==1
by bc_correlat: replace monto_tus_iecon = 1883 if (n_menores>3)  & bc_mes>9  & h157==1
