...
cap drop cuot_emp cuot_emp_tot seguro salud_aux ingre_ciud 
...
cap drop bc_otros bc_otros_ing bc_benef_ocup_secund
...
*-------------------------------------------------------------------------------
* Order
order bc_correlat bc_nper bc_filtloc bc_pesoan bc_mes bc_anio bc_dpto bc_ccz bc_area ///
bc_pe2 bc_pe3 bc_pe4 bc_pe5 bc_pe6a bc_pe6b ///
bc_pe11 bc_pe12 bc_pe13 bc_nivel bc_edu bc_finalizo ///
bc_pobp bc_pf41 bc_cat2 bc_pf081 bc_pf082 bc_pf40 bc_rama bc_pf39 bc_tipo_ocup ///
bc_pf07 bc_pf051 bc_pf052 bc_pf053 bc_pf06 bc_horas bc_horas_1 bc_pf04 bc_pf21 ///
bc_pf22 bc_pf26 bc_pf34 bc_reg_disse bc_register bc_register2 bc_subocupado ///
bc_pg11p bc_pg12p bc_pg13p bc_pg14p bc_pg15p bc_pg16p bc_pg17p /// 
...
bc_ytdop bc_ytdos bc_ytinde bc_ytransf bc_pt1 bc_pt2 bc_pt4 ///
...
bc_ht11 bc_ht11d bc_ht11_iecon bc_ht11_sss bc_salud bc_ht11_css ///
bc_percap_iecon bc_percap_ine

*-------------------------------------------------------------------------------
* Append servicio doméstico y sin hogar

append using "$rutainterm/servdom1", nol
