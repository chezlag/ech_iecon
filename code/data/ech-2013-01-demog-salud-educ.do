capture log close
log using "log/ech-2013-01-demog-salud-educ.log", replace text

//  ech-2013-01-demog-salud-educ.do
//  gsl \ 2021-10-06
...
local tag    "2013-01.do gsl `date'"
local fullnm "ech-2013-01-demog-salud-educ"
