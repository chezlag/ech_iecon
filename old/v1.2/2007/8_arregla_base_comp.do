...
*dropeo variables intermedias generadas para desagregar por fuentes
cap drop cuotmilit1 cuotmilit cuotabps emer_emp_d ytransf_1 filtas suma sumah bpc asig_jefe1 asig_jefe filtas2 asig_con1 asig_con filtas3 asig_otro1 asig_otro ytransf_2 ytransf_3 desay almuer comescol comehog canasta yaliment ytransf_4 ytransf_5 ytransf_6 pt2priv_1 pt2priv_2 pt2nodep_1 pt2nodep_2 men18 menor18 men18s cuot_otrohog_d cuot_otrohog cuot_otrohog_tot emer_otro_d emer_otro emer_otro_tot cuotmilit_otro_d cuotmilit_otro cuotmilit_otro_tot yaliment_men1 yaliment_men ht11_iecon_1 disse_p disse_s cuota_p cuota_o
*dropeo variables generadas para el hogar que se usan solo a los efectos de calcular ht11_nuev_cf y ht11_nuev
*cap drop as_privadosh as_publicosh as_otrosh as_agropech patronesh pat_agropech cpropiaslh cpropiaclh cp_agropech cooperath ot_agropech otros_labh ing_labh utilidadesh alqh interesesh ut_agropech otras_utilidadesh ot_utilidadesh otras_capitalh ing_caph jub_penh jub_peneh bs_socialesh ingre_ciudh transf_hogh beneficiosh val_loch 
...
recode bc_ccz (0=-9)
cap rename cuotmilit bc_cuotmilit
cap rename disse bc_disse
cap rename disse_p bc_disse_p
cap rename disse_s bc_disse_o

bysort bc_correlat: gen max_nper = _N
bysort bc_correlat: gen bc_percap_iecon = bc_ht11_sss/max_nper

foreach var in bc_pg14 bc_ht11_sss bc_ht11_css bc_percap_iecon bc_ht11_sss_corr {
...
append using "$rutainterm/servdom7", nol
