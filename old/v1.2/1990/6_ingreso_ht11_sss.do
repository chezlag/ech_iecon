*6_ ----------------------------------------------------------------------------
*ingresos rurales - estos están aparte para el período 1986-1990
cap g bc_pa11=pa11 
cap g bc_pa12=pa12 
cap g bc_pa13=pa13 
cap g bc_pa21=pa21 
...
cap g bc_pat_agropec=0
	replace bc_pat_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc if bc_anio<1991&bc_anio>1987&bc_cat2==3
	replace bc_pat_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc/1000 if bc_anio<1988&bc_cat2==3
...
cap g bc_cp_agropec= 0
	replace bc_cp_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc if bc_anio<1991&bc_anio>1987&bc_cat2==4
	replace bc_cp_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc/1000 if bc_anio<1988&bc_cat2==4
...
cap g bc_ot_agropec= 0
	replace bc_ot_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc if bc_anio<1991&bc_anio>1987&bc_cat2==5
	replace bc_ot_agropec=(bc_pa11+bc_pa12+bc_pa13+bc_pa21+bc_pa22+bc_pa31+bc_pa32)*bc_ipc/1000 if bc_anio<1988&bc_cat2==5
...
g bc_ing_lab=0
	replace bc_ing_lab=bc_as_privados+bc_as_publicos+bc_patrones+bc_cpropiasl+bc_cpropiacl+bc_cooperat+bc_as_otros+bc_as_agropec+bc_cp_agropec+bc_pat_agropec+bc_ot_agropec+(bc_otros_lab*bc_ipc) 
...
*-------------------------------------------------------------------------------
* Otros ingresos
rename pg191 bc_pg191
rename pg192 bc_pg192
...
*auxiliar para salud
g salud_aux=bc_cuotabps+bc_disse_p+bc_disse_o+bc_disse
