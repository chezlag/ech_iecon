...
* ipc
g bc_ipc=-15
replace bc_ipc=3.97902750541847 if bc_mes==1&bc_anio==1995
replace bc_ipc=3.85476821969826 if bc_mes==2&bc_anio==1995
replace bc_ipc=3.79001925764242 if bc_mes==3&bc_anio==1995
replace bc_ipc=3.65864387420939 if bc_mes==4&bc_anio==1995
replace bc_ipc=3.53383424371332 if bc_mes==5&bc_anio==1995
replace bc_ipc=3.45710636681905 if bc_mes==6&bc_anio==1995
replace bc_ipc=3.35526168310175 if bc_mes==7&bc_anio==1995
replace bc_ipc=3.27340796137304 if bc_mes==8&bc_anio==1995
replace bc_ipc=3.16538337875945 if bc_mes==9&bc_anio==1995
replace bc_ipc=3.10617423892246 if bc_mes==10&bc_anio==1995
replace bc_ipc=3.05989172887392 if bc_mes==11&bc_anio==1995
replace bc_ipc=3.00137822885031 if bc_mes==12&bc_anio==1995
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom95",replace
restore
drop if bc_pe4==7
