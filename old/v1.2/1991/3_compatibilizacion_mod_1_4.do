...
* ipc
g bc_ipc=-15
replace bc_ipc=25.274735893038 if bc_mes==1 & bc_anio==1991
replace bc_ipc=23.5712066251821 if bc_mes==2 & bc_anio==1991
replace bc_ipc=22.7738865663565 if bc_mes==3 & bc_anio==1991
replace bc_ipc=21.6902541722901 if bc_mes==4 & bc_anio==1991
replace bc_ipc=20.8862796007806 if bc_mes==5 & bc_anio==1991
replace bc_ipc=19.212264665488 if bc_mes==6 & bc_anio==1991
replace bc_ipc=18.4214728370744 if bc_mes==7 & bc_anio==1991
replace bc_ipc=17.6525772628226 if bc_mes==8 & bc_anio==1991
replace bc_ipc=16.6087692032415 if bc_mes==9 & bc_anio==1991
replace bc_ipc=15.5960648181298 if bc_mes==10 & bc_anio==1991
replace bc_ipc=15.0361077626926 if bc_mes==11 & bc_anio==1991
replace bc_ipc=14.3623299659307 if bc_mes==12 & bc_anio==1991
...
preserve
keep if bc_correlat==103269 | bc_correlat==107683 | bc_correlat==200716
drop _merge
save "$rutainterm/sinhogar91.dta", replace
restore
drop if _merge==1
drop _merge
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom91",replace
restore
drop if bc_pe4==7
