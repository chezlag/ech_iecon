...
recode pf082 (. =-15) (2/4=2) (5/9=3), g(bc_pf082)
...
* ipc
g bc_ipc=-15
replace bc_ipc=13.929107435768 if bc_mes==1&bc_anio==1992
replace bc_ipc=13.2379153717995 if bc_mes==2&bc_anio==1992
replace bc_ipc=12.9255736153045 if bc_mes==3&bc_anio==1992
replace bc_ipc=12.1331008590402 if bc_mes==4&bc_anio==1992
replace bc_ipc=11.6530770167592 if bc_mes==5&bc_anio==1992
replace bc_ipc=11.1351903541462 if bc_mes==6&bc_anio==1992
replace bc_ipc=10.8438956379898 if bc_mes==7&bc_anio==1992
replace bc_ipc=10.3767586413691 if bc_mes==8&bc_anio==1992
replace bc_ipc=9.94434174976971 if bc_mes==9&bc_anio==1992
replace bc_ipc=9.5460267215412 if bc_mes==10&bc_anio==1992
replace bc_ipc=9.20650161289724 if bc_mes==11&bc_anio==1992
replace bc_ipc=9.05311614446322 if bc_mes==12&bc_anio==1992
...
preserve
keep if ///
bc_correlat==11503146|bc_correlat==11503692|bc_correlat==11503997|bc_correlat==11504097| ///
bc_correlat==11505930|bc_correlat==11508910|bc_correlat==11509555|bc_correlat==11510469| ///
bc_correlat==11512560|bc_correlat==11513628|bc_correlat==11514383|bc_correlat==11514695| /// 
bc_correlat==11515465|bc_correlat==12604646|bc_correlat==12604718|bc_correlat==12609729| ///
bc_correlat==12617134|bc_correlat==12617982
drop _merge
save "$rutainterm/sinhogar92.dta", replace
restore
drop if _merge==1
drop _merge
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom92",replace
restore
drop if bc_pe4==7
