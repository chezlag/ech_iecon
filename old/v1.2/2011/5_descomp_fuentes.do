...
*/ +g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12)+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT + CUOT_EMP_IAMC_TOT + corr_sal_esp if bc_pf41==1 // + +CUOT_EMP_ASSE_TOT

gen bc_pg27p=g126_8+g127_3+g128_1+g129_2+g130_1+(g127_1*mto_desa)+(g127_2*mto_alm) /*
*/ +g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12)+EMER_EMP_TOT+CUOT_EMP_PRIV_TOT+CUOT_EMP_IAMC_TOT + corr_sal_esp if bc_pf41==2 // +CUOT_EMP_ASSE_TOT
...
replace bc_pg17o = bc_pg17o + EMER_EMP_TOT + CUOT_EMP_PRIV_TOT + CUOT_EMP_IAMC_TOT if f92==1 & (bc_pf41!=1 & bc_pf41!=2) // Se saca + CUOT_EMP_ASSE_TOT 
...
gen bc_pg33p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT if bc_pf41==5  // Cp sin local. Se saca +CUOT_EMP_ASSE_TOT
gen bc_pg41p=g142 +(g145+g146+g147)/12 if bc_pf41==6  // Cp con local
gen bc_pg43p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT  if bc_pf41==6  // Cp con local. Se saca +CUOT_EMP_ASSE_TOT
gen bc_pg51p=g142 +(g145+g146+g147)/12 if bc_pf41==4  // patrón
gen bc_pg52p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT if bc_pf41==4 // patrón. Se saca +CUOT_EMP_ASSE_TOT
gen bc_pg71p=g142 +(g145+g146+g147)/12 if bc_pf41==3  // cooperativista
gen bc_pg73p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT if bc_pf41==3 // cooperativista. Se saca +CUOT_EMP_ASSE_TOT
...
replace bc_otros_benef=YTRANSF_4+YALIMENT_MEN1+YTRANSF_2 if (g150==1|g150==2)&(afam_pe>0)  // 08/04/19 cambio
