...
save  "$rutainterm\p10.dta", replace
...
g suma= (a+b+c+d+e+f) * 1.22 // genera salari nominal total para comparar y ver qué monto le toca

drop a b c d e f

g monto_jefe =329.76 if suma<= 12366
replace monto_jefe=164.88 if suma>12366
...
g monto_cony =329.76 if suma<= 12366
replace monto_cony=164.88 if suma>12366
...
g monto_afam_pe=0
	...
	replace monto_afam_pe=(809.44*((g151_1+g151_2+g151_3)^0.6)+346.91*(g151_3^0.6)) if bc_mes>1 &afam_pe==1
...
gen suma5 = suma1 + suma2 + suma3 + suma4
drop suma1 suma2 suma3 suma4
sort bc_correlat nucleo
by bc_correlat nucleo: egen suma_n=sum(suma5)
...
by bc_correlat: replace monto_tus_iecon = 479 if (n_menores==1 | n_menores==0) & bc_mes<2   & h157==1
by bc_correlat: replace monto_tus_iecon = 489 if (n_menores==1 | n_menores==0) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 523 if (n_menores==1 | n_menores==0) & bc_mes>7   & h157==1

by bc_correlat: replace monto_tus_iecon = 726 if (n_menores==2) & bc_mes<2   & h157==1
by bc_correlat: replace monto_tus_iecon = 741 if (n_menores==2) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 793 if (n_menores==2) & bc_mes>7   & h157==1

by bc_correlat: replace monto_tus_iecon = 924 if  (n_menores==3) & bc_mes<2   & h157==1
by bc_correlat: replace monto_tus_iecon = 943 if  (n_menores==3) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1009 if (n_menores==3) & bc_mes>7   & h157==1

by bc_correlat: replace monto_tus_iecon = 1287 if (n_menores>3) & bc_mes<2   & h157==1
by bc_correlat: replace monto_tus_iecon = 1314 if (n_menores>3) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1406 if (n_menores>3) & bc_mes>7   & h157==1
...
gen salud = fonasa + ytdos_2 +ytdop_2  // A fonasa, se le suman cuotas mutuales militares ($)
