...
*/ +g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12) + corr_sal_esp if bc_pf41==1 // + +CUOT_EMP_ASSE_TOT +EMER_EMP_TOT +CUOT_EMP_PRIV_TOT + CUOT_EMP_IAMC_TOT

gen bc_pg27p=g126_8+g127_3+g128_1+g129_2+g130_1+(g127_1*mto_desa)+(g127_2*mto_alm) /*
*/ +g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12) + corr_sal_esp if bc_pf41==2 // +CUOT_EMP_ASSE_TOT +EMER_EMP_TOT+CUOT_EMP_PRIV_TOT+CUOT_EMP_IAMC_TOT
...
gen otros=0
replace otros=bc_pag_at+g154_1
replace otros=(h171_1)/12+bc_pag_at+g154_1 if bc_pe4==1
