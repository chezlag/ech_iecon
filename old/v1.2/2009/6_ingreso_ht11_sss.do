...
gen bc_bs_sociales=(bc_pg13p+bc_pg23p+bc_pg32p+bc_pg42p+bc_pg72p+bc_otros_benef+ bc_pg101+ bc_pg102+benef_ocup_secund+bc_seguro)
cap drop bs_socialesh
egen bs_socialesh=sum(bc_bs_sociales) if bc_pe4!=7, by(bc_correlat)
replace bs_socialesh=bs_socialesh+bc_tarjeta
