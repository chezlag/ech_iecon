...
* Tipo de ocupación
g pf39aux=pf39
	replace pf39aux="" if pf39=="X21"|pf39=="x21"
destring pf39aux, replace
g bc_pf39=pf39aux
	replace bc_pf39=-9 if bc_pobp!=2
	replace bc_pf39= 0 if pf39aux>0&pf39aux<13&bc_pobp==2 //militares hasta marzo2005  
	replace bc_pf39=-15 if bc_pf39==.&bc_pobp==2

g auxpf39=pf39aux
	replace auxpf39=0 if pf39aux>0&pf39aux<13 // Esta línea para el período a continuación ((bc_anio>1985&bc_anio<2005)|(bc_anio==2005&(bc_mes==1|bc_mes==2|bc_mes==3))) // militares 
	replace auxpf39=pf39aux*10 if pf39aux>12&pf39aux<1000 // ídem anterior 
...
* ipc
g bc_ipc=-15
replace bc_ipc=1.81312927909787 if bc_mes==1&bc_anio==2000
replace bc_ipc=1.80629112502006 if bc_mes==2&bc_anio==2000
replace bc_ipc=1.80022392834293 if bc_mes==3&bc_anio==2000
replace bc_ipc=1.78920594547333 if bc_mes==4&bc_anio==2000
replace bc_ipc=1.78141817030706 if bc_mes==5&bc_anio==2000
replace bc_ipc=1.77327871435324 if bc_mes==6&bc_anio==2000
replace bc_ipc=1.76452143920985 if bc_mes==7&bc_anio==2000
replace bc_ipc=1.75790706755174 if bc_mes==8&bc_anio==2000
replace bc_ipc=1.74875699192045 if bc_mes==9&bc_anio==2000
replace bc_ipc=1.74199040396223 if bc_mes==10&bc_anio==2000
replace bc_ipc=1.7300745523019 if bc_mes==11&bc_anio==2000
replace bc_ipc=1.729277099178 if bc_mes==12&bc_anio==2000
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom0",replace
restore
drop if bc_pe4==7
