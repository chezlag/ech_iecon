...
replace bc_otros_benef=g148_4+mto_hogc+YTRANSF_4+YALIMENT_MEN1 if bc_pf41!=1 & bc_pf41!=2 & bc_pf41!=3 & bc_pf41!=5 & bc_pf41!=6 & f92!=1 & f92!=2 & f92!=3 & f92!=5 & f92!=6 
...
*replace bc_otros_benef=YTRANSF_4+YALIMENT_MEN1+YTRANSF_2 if (g150==1)&(afam_pe>0)
*replace bc_otros_benef=YTRANSF_4+YALIMENT_MEN1+YTRANSF_2 if (g150!=1)&(afam_pe>0)  // 2. La línea anterior estaba mal, se corrige 08/11/18 
*replace bc_otros_benef=YTRANSF_4+YALIMENT_MEN1+YTRANSF_2+g148_4 if (g150!=1)&(afam_pe>0)  // 1. Se suma afam pe y compensación por accidente 08/11/18
replace bc_otros_benef=YTRANSF_4+YALIMENT_MEN1+YTRANSF_2 if (g150==1|g150==2)&(afam_pe>0) // 3. 08/04/19 cambio
