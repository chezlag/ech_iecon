...
gen ytdos_3 = 0
replace ytdos_3 = mto_cuot if (((e27>= 14 & (f92 < 3 | f92 == 7) & ytdop_2==0 & ytdop_3==0) & f96==1) & (e45_1_1 == 1| e45_2_1== 1 | e45_3_1== 1)) // Por qué no se incluye ytdos_2???
...
g leche = e561_1*lecheenpol 
	replace leche=0 if ((e246 == 1| e246 == 7) & e560 == 2 ) // Ver sintaxis 2018 (por qué hacemos replace?)
...
g monto_afam_pe=0
	replace monto_afam_pe=(1496.1*((g151_6+g151_3)^0.6)+641.2*(g151_3^0.6))+g151_4*(1496.1+641.2) if bc_mes==1 &afam_pe==1
	replace monto_afam_pe=(1615.2*((g151_6+g151_3)^0.6)+692.3*(g151_3^0.6))+g151_4*(1615.2+692.3) if afam_pe==1&bc_mes>1
...
gen suma3=(g142 +g143/12)                 if (((f73>=3&f73<=6)&f82==1)|((f92>=3&f92<=6)&f96==1)) // Suma de ingresos trabajador independiente
gen suma4= g148_1_1 + g148_1_2 + g148_1_3 + g148_1_4 + g148_1_5 + g148_1_6 + g148_1_7 + g148_1_8 + g148_1_9 + g148_1_10 + g148_1_11 + g148_1_12 /*
*/+ g148_2_1 + g148_2_2 + g148_2_3 + g148_2_4 + g148_2_5 + g148_2_6 + g148_2_7 + g148_2_8 + g148_2_9 + g148_2_10 + g148_2_11 + g148_2_12 // Suma de ingresos jubilados o pensionistas
