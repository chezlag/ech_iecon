...
* Enero
gen afameq=0
replace afameq= 1010.27*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 432.98*(g151_3_1^0.6) + 1443.25*g151_4 if bc_mes==1 & g256==2 & g152==1
replace afameq= 1010.27*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 432.98*(g151_3_1^0.6) + 1443.25*g151_4 if bc_mes==1 & (g150==1 & (pobpcoac == 3 | pobpcoac == 4 | pobpcoac == 6 | pobpcoac == 7 | pobpcoac == 8 | pobpcoac == 11 | (pobpcoac == 2 & f82 != 1 & f96 != 1)))
replace afameq= 1010.27*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 432.98*(g151_3_1^0.6) + 1443.25*g151_4 if bc_mes==1 & g255==1 & g256==2


*Resto del año.
replace afameq= 1096.35*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 469.87*(g151_3_1^0.6) + 1566.22*g151_4 if bc_mes>1 & g256==2 & g152==1
replace afameq= 1096.35*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 469.87*(g151_3_1^0.6) + 1566.22*g151_4 if bc_mes>1 & (g150==1 & (pobpcoac == 3 | pobpcoac == 4 | pobpcoac == 6 | pobpcoac == 7 | pobpcoac == 8 | pobpcoac == 11 | (pobpcoac == 2 & f82 != 1 & f96 != 1)))
replace afameq= 1096.35*((g151_1+g151_2+g151_3+g151_5)^0.6)+ 469.87*(g151_3_1^0.6) + 1566.22*g151_4 if bc_mes>1 & g255==1 & g256==2
...
gen monto_asig=0
replace monto_asig=451.04 if suma_nucleo<=16914
replace monto_asig=225.52 if suma_nucleo>16914

gen asig_total= monto_asig*(g151_1+g151_2+g151_3+g151_5+(g151_4*2))
gen afam= asig_total if g256 == 2 & g152 == 2 & afameq == 0
recode afam .=0
...
g YTRANSF_1 = 0
	replace YTRANSF_1 = g148_1_1 + g148_1_2 + g148_1_3 + g148_1_4 + g148_1_5 + g148_1_6 + g148_1_7 + g148_1_8 + g148_1_9 + /*
	*/ g148_1_12 + g148_1_10 + g148_1_11 + g148_2_1+ g148_2_2 + g148_2_3 + g148_2_4+ g148_2_5+ g148_2_6+ g148_2_7+ g148_2_8+/*
	*/ g148_2_9 + g148_2_12 + g148_2_10+ g148_2_11+ g148_3 + g148_4 + g148_5_1 + g148_5_2+ g153_1+ g153_2 
...
*/(h164/12)+(h165/12)+(h166/12) + (h269_1/12) +(h167_1_1/12)+(h167_1_2/12)+ (h167_2_1/12) + (h167_2_2/12)+ /*
*/ (h167_3_1/12) + (h167_3_2/12) +(h167_4_1/12) + (h167_4_2/12)+ (h170_1/12)+(h170_2/12)+ (h271_1/12) + /*
*/(h171_1/12)+(h172_1/12)+ cuotmilit_hogar + YALIMENT_MEN + totfonasa_hogar2 +EMER_OTRO_TOT+  CUOT_OTROHOG2
...
g monto_afam_pe=0
	replace monto_afam_pe=(1010.27*((g151_5+g151_1+g151_2+g151_3)^0.6)+432.98*(g151_3_1^0.6))+g151_4*(1010.27+432.98) if bc_mes==1 &afam_pe==1
	replace monto_afam_pe=(1096.35*((g151_5+g151_1+g151_2+g151_3)^0.6)+469.87*(g151_3_1^0.6))+g151_4*(1096.35+469.87) if afam_pe==1&bc_mes>1
...
by bc_correlat: replace monto_tus_iecon = 700 if (n_menores==1 | n_menores==0) & bc_mes==1   & h157==1
by bc_correlat: replace monto_tus_iecon = 736 if (n_menores==1 | n_menores==0) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 771 if (n_menores==1 | n_menores==0) & bc_mes>7   & h157==1

by bc_correlat: replace monto_tus_iecon = 1062 if (n_menores==2) & bc_mes==1   & h157==1
by bc_correlat: replace monto_tus_iecon = 1117 if (n_menores==2) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1170 if (n_menores==2)  & bc_mes>7  & h157==1

by bc_correlat: replace monto_tus_iecon = 1350 if (n_menores==3) & bc_mes==1   & h157==1
by bc_correlat: replace monto_tus_iecon = 1420 if (n_menores==3) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 1488 if (n_menores==3)  & bc_mes>7  & h157==1

by bc_correlat: replace monto_tus_iecon = 1883 if (n_menores>3) & bc_mes==1   & h157==1
by bc_correlat: replace monto_tus_iecon = 1980 if (n_menores>3) & 1<bc_mes<8 & h157==1
by bc_correlat: replace monto_tus_iecon = 2074 if (n_menores>3)  & bc_mes>7  & h157==1
