...
*-------------------------------------------------------------------------------
*- Se agrega emergencia otro hogar
...
*-------------------------------------------------------------------------------
*- Imputación de ingresos en especie de alimentación de menores
...
replace bc_otras_utilidades=h170_1/12+h170_2/12+g143/12+h271_1/12 if ((bc_pf41!=3 & bc_pf41!=4 & f92!=3 & f92!=4)| (bc_pf41==-9 & f92==0)) & bc_pe4==1 

gen bc_ot_utilidades=0
replace bc_ot_utilidades=h170_1/12+h170_2/12+h271_1/12 if (bc_pf41==3 | bc_pf41==4 | f92==3 | f92==4 )& bc_pe4==1 // 08/04/19 agregué h271_1
