...
* ipc
g bc_ipc=-15
replace bc_ipc=2.9379536240441 if bc_mes==1&bc_anio==1996
replace bc_ipc=2.87960992693128 if bc_mes==2&bc_anio==1996
replace bc_ipc=2.8371077888408 if bc_mes==3&bc_anio==1996
replace bc_ipc=2.78373360886623 if bc_mes==4&bc_anio==1996
replace bc_ipc=2.70671542837023 if bc_mes==5&bc_anio==1996
replace bc_ipc=2.65118314551915 if bc_mes==6&bc_anio==1996
replace bc_ipc=2.61740099794234 if bc_mes==7&bc_anio==1996
replace bc_ipc=2.57446039710723 if bc_mes==8&bc_anio==1996
replace bc_ipc=2.52029422500022 if bc_mes==9&bc_anio==1996
replace bc_ipc=2.45887741573551 if bc_mes==10&bc_anio==1996
replace bc_ipc=2.42064564925243 if bc_mes==11&bc_anio==1996
replace bc_ipc=2.39186889865779 if bc_mes==12&bc_anio==1996
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom96",replace
restore
drop if bc_pe4==7
