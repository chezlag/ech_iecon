capture log close
log using "log/ech-2020-08-arregla-base-comp.log", replace text

//  ech-2020-08-arregla-base-comp.do
//  gsl \ 2021-09-29
...
local tag    "2019-08.do gsl `date'"
local fullnm "ech-2020-08-arregla-base-comp"
...
append using "data/tmp/servdom19", nol
sort bc_correlat bc_nper
...
quietly compress		
notes: ech-2020-06.dta \ ingreso ht11 iecon \ `tag'
label data "ECH 2020 [tmp 6] \ `date'"
datasignature set, reset
save  "data/tmp/ech-2020-06.dta", replace
