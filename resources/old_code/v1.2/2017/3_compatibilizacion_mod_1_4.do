...
g bc_pe5=.
	...
	replace bc_pe5=2 if e36==3
	replace bc_pe5=3 if e36==2 | (e36==3 & (e35==2 | e35==3))
...
replace	bc_ipc=	0.45375597	if	bc_mes==	1	&	bc_anio==	2017
replace	bc_ipc=	0.44286367	if	bc_mes==	2	&	bc_anio==	2017
replace	bc_ipc=	0.43991003	if	bc_mes==	3	&	bc_anio==	2017
replace	bc_ipc=	0.43689306	if	bc_mes==	4	&	bc_anio==	2017
replace	bc_ipc=	0.43592207	if	bc_mes==	5	&	bc_anio==	2017
replace	bc_ipc=	0.43515855	if	bc_mes==	6	&	bc_anio==	2017
replace	bc_ipc=	0.43411938	if	bc_mes==	7	&	bc_anio==	2017
replace	bc_ipc=	0.43275826	if	bc_mes==	8	&	bc_anio==	2017
replace	bc_ipc=	0.42929361	if	bc_mes==	9	&	bc_anio==	2017
replace	bc_ipc=	0.42698187	if	bc_mes==	10	&	bc_anio==	2017
replace	bc_ipc=	0.42498549	if	bc_mes==	11	&	bc_anio==	2017
replace	bc_ipc=	0.42372914	if	bc_mes==	12	&	bc_anio==	2017
...
save "$rutainterm/servdom17.dta", replace
restore
drop if e30==14
