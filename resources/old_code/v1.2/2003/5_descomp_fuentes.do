...
replace bc_otros_lab=g1_1_1+g1_1_2+g1_1_3+g1_1_4+g1_1_5+g1_1_6+g1_1_7+g1_1_8+g3_8+g3_4 if bc_pf41==-9 | bc_pf41==7 // Se agrega esta línea 08/10/18, 9/10 agrego bc_pf41==7
replace bc_otros_lab=bc_otros_lab+g2_1+g2_2 if (bc_pf41==-9 | bc_pf41==7) & (2<=bc_pobp<=5) // Se agrega esta línea (ver caso 11145) y se agrega bc_pf41a==7 (ver caso 12593), también se agrega pobp (Ver caso 14805)
