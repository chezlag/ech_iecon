...
*/
g bc_pe6a=-15
	replace bc_pe6a=3 if e6_1_1==3
	replace bc_pe6a=2 if e5_5==1 & e6_1_1!=3
	replace bc_pe6a=4 if (e5_1==1 | e5_2==1 | e5_3==1 | e5_4==1) & (e5_5!=1&e6_1_1!=3)
	*replace bc_pe6a=5 if (e5_6_1==1|e7==1)&e5_1!=1&e5_2!=1&e5_3!=1&e5_4!=1&e5_5!=1&e6_1_1!=3
	*replace bc_pe6a=5 if (e5_6_1==1|e7==1)&e5_1!=1&e5_2!=1&e5_3!=1&e5_4!=1&e5_5!=1
	replace bc_pe6a=5 if (e7==1&e5_5!=1) | (e5_6_1==1|e7==1)&e5_1!=1&e5_2!=1&e5_3!=1&e5_4!=1&e5_5!=1
	replace bc_pe6a=1 if e5_1!=1&e5_2!=1&e5_3!=1&e5_4!=1&e5_5!=1&e5_6_1!=1
...
cap drop pf39aux
g pf39aux=bc_pf39
replace pf39aux=0 if bc_pf39>0 & bc_pf39<13 & (bc_anio==2005 & (bc_mes==1 | bc_mes==2 | bc_mes==3)) // militares 
replace pf39aux=bc_pf39*10 if bc_pf39>12 & bc_pf39<1000 & (bc_anio==2005 & (bc_mes==1 | bc_mes==2 | bc_mes==3))

replace pf39aux=0 if bc_pf39>0 & bc_pf39<130 & (bc_anio>2005 | (bc_anio==2005 & bc_mes>3)) // militares 

cap drop bc_tipo_ocup
gen bc_tipo_ocup=trunc(pf39aux/1000) if bc_pf39!=-9
	replace bc_tipo_ocup=-9 if bc_pf39==-9
* Cantidad de empleos
...
replace	bc_ipc=	1.20066140	if	bc_mes==1	& bc_anio==	2004
replace	bc_ipc=	1.17496607	if	bc_mes==2	& bc_anio==	2004
replace	bc_ipc=	1.17478211	if	bc_mes==3	& bc_anio==	2004
replace	bc_ipc=	1.16777340	if	bc_mes==4	& bc_anio==	2004
replace	bc_ipc=	1.15353080	if	bc_mes==5	& bc_anio==	2004
replace	bc_ipc=	1.14165441	if	bc_mes==6	& bc_anio==	2004
replace	bc_ipc=	1.13790314	if	bc_mes==7	& bc_anio==	2004
replace	bc_ipc=	1.12651386	if	bc_mes==8	& bc_anio==	2004
replace	bc_ipc=	1.11336433	if	bc_mes==9	& bc_anio==	2004
replace	bc_ipc=	1.11034381	if	bc_mes==10	& bc_anio==	2004
replace	bc_ipc=	1.11402554	if	bc_mes==11	& bc_anio==	2004
replace	bc_ipc=	1.11695529	if	bc_mes==12	& bc_anio==	2004
replace	bc_ipc=	1.11595855	if	bc_mes==1	& bc_anio==	2005
replace	bc_ipc=	1.11176964	if	bc_mes==2	& bc_anio==	2005
replace	bc_ipc=	1.11182456	if	bc_mes==3	& bc_anio==	2005
replace	bc_ipc=	1.10706733	if	bc_mes==4	& bc_anio==	2005
replace	bc_ipc=	1.09580372	if	bc_mes==5	& bc_anio==	2005
replace	bc_ipc=	1.09559038	if	bc_mes==6	& bc_anio==	2005
replace	bc_ipc=	1.09266540	if	bc_mes==7	& bc_anio==	2005
replace	bc_ipc=	1.07878846	if	bc_mes==8	& bc_anio==	2005
replace	bc_ipc=	1.07651841	if	bc_mes==9	& bc_anio==	2005
replace	bc_ipc=	1.06819152	if	bc_mes==10	& bc_anio==	2005
replace	bc_ipc=	1.06485643	if	bc_mes==11	& bc_anio==	2005
replace	bc_ipc=	1.06611727	if	bc_mes==12	& bc_anio==	2005
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom5",replace
restore
drop if bc_pe4==7
