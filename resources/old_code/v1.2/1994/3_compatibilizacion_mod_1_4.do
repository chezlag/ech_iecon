...
recode pe12 (0 3 .=-15), g(bc_pe12) 
	...
	replace bc_pe12=-3 if bc_pe11==1&bc_pe12==2
...
recode pf21 (5 6 =-15) (.=-9), g(bc_pf21) 
...
* ipc
g bc_ipc=-15
replace bc_ipc=5.73423852027708 if bc_mes==1&bc_anio==1994
replace bc_ipc=5.5453750806792 if bc_mes==2&bc_anio==1994
replace bc_ipc=5.46724214263695 if bc_mes==3&bc_anio==1994
replace bc_ipc=5.31678563184672 if bc_mes==4&bc_anio==1994
replace bc_ipc=5.13580006908398 if bc_mes==5&bc_anio==1994
replace bc_ipc=4.99788690355779 if bc_mes==6&bc_anio==1994
replace bc_ipc=4.86131216423112 if bc_mes==7&bc_anio==1994
replace bc_ipc=4.71229539873225 if bc_mes==8&bc_anio==1994
replace bc_ipc=4.56921477218358 if bc_mes==9&bc_anio==1994
replace bc_ipc=4.41823287158134 if bc_mes==10&bc_anio==1994
replace bc_ipc=4.26885448775091 if bc_mes==11&bc_anio==1994
replace bc_ipc=4.10720860064759 if bc_mes==12&bc_anio==1994
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom94",replace
restore
drop if bc_pe4==7
