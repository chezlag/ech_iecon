...
*****YTRANSF_2=asignaciones, (g150==1&g256!=1) es que no incluidas en el sueldo
...
gen bc_pg33p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT if bc_pf41==5  // Cp sin local
gen bc_pg41p=g142 +(g145+g146+g147)/12 if bc_pf41==6  // Cp con local
gen bc_pg43p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT if bc_pf41==6  // Cp con local
gen bc_pg51p=g142 +(g145+g146+g147)/12 if bc_pf41==4  // patrón
gen bc_pg52p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT if bc_pf41==4 // patrón
gen bc_pg71p=g142 +(g145+g146+g147)/12 if bc_pf41==3  // cooperativista
gen bc_pg73p=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT +CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT if bc_pf41==3 // cooperativista
...
*replace bc_otros_benef=YTRANSF_4+yaliment_men+YTRANSF_2 if (g150==1&g256!=1)&(afam_pe>0)
replace bc_otros_benef=YTRANSF_4+yaliment_men+YTRANSF_2 if (g150==1|g257>0)&(afam_pe>0) // 08/04/19 cambio
...
replace bc_otras_utilidades=h170_1/12+h170_2/12+g143/12 if ((bc_pf41!=3 & bc_pf41!=4 & f92!=3 & f92!=4)| (bc_pf41==-9 & f92==0)) & bc_pe4==1 
