...
* ipc
g bc_ipc=-15
replace bc_ipc=2.05177285571051 if bc_mes==1&bc_anio==1998
replace bc_ipc=2.02355267889248 if bc_mes==2&bc_anio==1998
replace bc_ipc=2.01179730092055 if bc_mes==3&bc_anio==1998
replace bc_ipc=2.00391703017894 if bc_mes==4&bc_anio==1998
replace bc_ipc=1.99185912751084 if bc_mes==5&bc_anio==1998
replace bc_ipc=1.98064232292125 if bc_mes==6&bc_anio==1998
replace bc_ipc=1.96199773380981 if bc_mes==7&bc_anio==1998
replace bc_ipc=1.93734400550822 if bc_mes==8&bc_anio==1998
replace bc_ipc=1.92228864218617 if bc_mes==9&bc_anio==1998
replace bc_ipc=1.90973105964198 if bc_mes==10&bc_anio==1998
replace bc_ipc=1.89653719774202 if bc_mes==11&bc_anio==1998
replace bc_ipc=1.89048458889729 if bc_mes==12&bc_anio==1998
...
preserve 
keep if bc_pe4==7
save "$rutainterm/servdom98",replace
restore
drop if bc_pe4==7
