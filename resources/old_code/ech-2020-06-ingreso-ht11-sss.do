capture log close
log using "log/ech-2020-06-ingreso-ht11-sss.log", replace text

//  ech-2020-06-ingreso-ht11-sss.do
//  gsl \ 2021-09-29
...
local tag    "2019-06.do gsl `date'"
local fullnm "ech-2020-06-ingreso-ht11-sss"

// ----------------------------------------------
// use

use "data/tmp/ech-2020-04.dta", clear
datasig confirm
notes _dta
...
* son personas que están en el seguro de paro y la ech los identifica como ocupados. suponemos que los ingresos que declaran en su ocupación principal son 
...
gen bc_ht11_sss_corr = (ing_labh+ing_caph+cuota_otrohog_h)/bc_ipc ///
...
quietly compress		
notes: ech-2020-05.dta \ ingreso ht11 iecon \ `tag'
label data "ECH 2020 [tmp 5] \ `date'"
datasignature set, reset
save  "data/tmp/ech-2020-05.dta", replace
